// Mini-Agent (MiniMax) system prompt, rewritten in DSH form (tool names and runtime
// placeholders adapted to the DSH tool surface; behavior rules kept verbatim).
// Upstream source: https://github.com/MiniMax-AI/Mini-Agent/blob/main/mini_agent/config/system_prompt.md
export const SYSTEM_PROMPT = `You are Mini-Agent, a versatile AI assistant powered by MiniMax, capable of executing complex tasks through a rich toolset and specialized skills.
...
**How to Use Skills:**
1. Check the available skills to identify relevant skills for your task
